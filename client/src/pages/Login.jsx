      ...
      <div style={{ width: "100%", maxWidth: "400px" }}>
        ...
        <div style={{
          ...
          <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "6px" }}>
                <label style={{ fontSize: "12px", fontWeight: 600, color: "#374151", letterSpacing: "0.4px" }}>PASSWORD</label>
                <Link to="/forgot-password" style={{ fontSize: "12px", color: "#00D4B1", fontWeight: 600, textDecoration: "none" }}>
                  Lupa password?
                </Link>
              </div>
              <div style={{ position: "relative" }}>
            ...
            <button
              ...
              style={{
                ...
                marginTop: "4px", letterSpacing: "0.3px", transition: "background .2s"
              }}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px", margin: "24px 0" }}>
            ...
            <span style={{ fontSize: "12px", color: "#9CA3AF", whiteSpace: "nowrap" }}>atau masuk dengan</span>
            <div style={{ flex: 1, height: "1px", background: "#E5E7EB" }} />
          </div>
        ...
        <p style={{ textAlign: "center", marginTop: "24px", fontSize: "14px", color: "#9CA3AF" }}>
          Belum punya akun?{" "}
          <Link to="/register" style={{ color: "#00D4B1", fontWeight: 700, textDecoration: "none" }}>
            Daftar sekarang
          </Link>
        </p>
      </div>
